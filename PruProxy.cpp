...
bool PruProxy::UpdateInput()
{
	if(Enabled)
	{
		Input1 = (*(unsigned long *)(sharedMem + 0x104))/200;
		Input2 = (*(unsigned long *)(sharedMem + 0x114)/200);
		Input3 = (*(unsigned long *)(sharedMem + 0x124)/200);
		Input4 = (*(unsigned long *)(sharedMem + 0x134)/200);
	}
	return true;
...
bool PruProxy::UpdateOutput()
{
	if(Enabled)
	{
		*(unsigned long *)(sharedMem + 0x200) = Output1;
		*(unsigned long *)(sharedMem + 0x210) = Output2;
